...
@RestController
@RequestMapping("/api/setWithdrawPwd")
public class ApiSetWithdrawPwdController {
    ...
    @RequestMapping
    public ResponseEntity<PcData> setWithdrawPwd(HttpServletRequest request, @Valid String withdrawpwd) {
        PcData pcData = null;
